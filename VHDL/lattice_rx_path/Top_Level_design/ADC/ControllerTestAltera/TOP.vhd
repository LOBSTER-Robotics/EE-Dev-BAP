...
u_Fifosm0 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x0,
...
u_Fifosm1 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x1,
...
u_Fifosm2 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x2,
...
u_Fifosm3 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x3,
...
u_Fifosm4 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x4,
...
u_Fifosm5 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x5,
...
u_Fifosm6 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x6,
...
u_Fifosm7 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x7,
...
u_Fifosm8 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x8,
...
u_Fifosm9 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x9,
...
u_Fifosm10 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x10,
...
u_Fifosm11 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x11,
...
u_Fifosm12 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x12,
...
u_Fifosm13 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x13,
...
u_Fifosm14 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x14,
...
u_Fifosm15 : entity work.Fifo    port map (
        aclr         => rst,
        clock        => clk,
        data         => data_x15,
