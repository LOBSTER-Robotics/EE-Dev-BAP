...
-- Module  Version: 5.1
--E:\Apps\Lattice Diamond\ispfpga\bin\nt64\scuba.exe -w -n Fifolg -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00m -type ebfifo -sync_mode -depth 2048 -width 8 -no_enable -pe 31 -pe2 32 -pf 1440 -pf2 1400 -reset_rel SYNC 

-- Wed Jun 03 17:09:53 2026
...
begin
    ...
    af_set_cmp_2: CCU2C
        generic map (INJECT1_1=> "NO", INJECT1_0=> "NO", INIT1=> X"99AA", 
        INIT0=> X"99AA")
        port map (A0=>fcount_4, A1=>fcount_5, B0=>cnt_con, 
    ...
    af_set_cmp_5: CCU2C
        ...
        port map (A0=>fcount_10, A1=>fcount_11, B0=>scuba_vhi, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co4_7, S0=>open, S1=>open, 
            COUT=>af_set_d_c);
    ...
    af_clr_cmp_5: CCU2C
        ...
        port map (A0=>fcount_10, A1=>fcount_11, B0=>scuba_vhi, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co4_8, S0=>open, S1=>open, 
            COUT=>af_clr_d_c);
