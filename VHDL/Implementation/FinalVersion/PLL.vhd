...
-- Module  Version: 5.7
--E:\Apps\Lattice Diamond\ispfpga\bin\nt64\scuba.exe -w -n PLL -lang vhdl -synth lse -bus_exp 7 -bb -arch sa5p00m -type pll -fin 100.00 -fclkop 50.00 -fclkop_tol 0.0 -fclkos 80.00 -fclkos_tol 0.0 -phases 0 -phase_cntl STATIC -fb_mode 1 

-- Thu Jun 11 09:39:53 2026
...
architecture Structure of PLL is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "80.000000";
    ...
    attribute ICP_CURRENT of PLLInst_0 : label is "15";
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  15, PLL_LOCK_MODE=>  0, 
        ...
        CLKOS2_DIV=>  1, CLKOS_DIV=>  10, CLKOP_DIV=>  16, CLKFB_DIV=>  1, 
