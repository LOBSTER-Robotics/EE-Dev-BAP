...
-- Module  Version: 5.7
--E:\Apps\Lattice Diamond\ispfpga\bin\nt64\scuba.exe -w -n PLL -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00m -type pll -fin 100.00 -fclkop 8 -fclkop_tol 10.0 -phase_cntl STATIC -fb_mode 5 

-- Fri Jun 05 14:03:10 2026
...
architecture Structure of PLL is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "8.333333";
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  77, PLL_LOCK_MODE=>  0, 
        ...
        CLKOS2_DIV=>  1, CLKOS_DIV=>  1, CLKOP_DIV=>  78, CLKFB_DIV=>  1, 
        CLKI_DIV=>  12, FEEDBK_PATH=> "INT_OP")
