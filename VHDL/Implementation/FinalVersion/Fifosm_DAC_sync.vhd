...
-- Module  Version: 5.1
--E:\Apps\Lattice Diamond\ispfpga\bin\nt64\scuba.exe -w -n Fifosm_DAC_sync -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00m -type ebfifo -sync_mode -depth 128 -width 16 -no_enable -pe 10 -pe2 12 -pf 110 -pf2 100 -reset_rel SYNC 

-- Wed May 27 11:54:06 2026
...
architecture Structure of Fifosm_DAC is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "Fifosm_DAC_sync.lpc";
...
begin
    ...
    pdp_ram_0_0_0: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>Data(15), 
            ...
            ADA11=>scuba_vlo, ADA10=>wcount_6, ADA9=>wcount_5, 
            ...
            ADB11=>scuba_vlo, ADB10=>rcount_6, ADB9=>rcount_5, 
            ...
            DOA0=>open, DOB17=>open, DOB16=>open, DOB15=>Q(15), 
