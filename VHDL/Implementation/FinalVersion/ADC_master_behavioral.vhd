...
architecture Behavioral of ADC_SPI_Config is
    ...
    signal next_mosi_reg : std_logic := '0';
    ...
    -- WAIT COUNTER
    --------------------------------------------------------------------
    signal wait_reset_counter : integer range 0 to 80000 := 0;
    signal next_wait_reset_counter : integer range 0 to 80000 := 0;
...
begin
    ...
    begin
        if RESET_N = '1' then
            ...
            RangeLEDs <= not std_logic_vector(to_unsigned(STATE_DEBUG, RangeLEDs'length));
    ...
    --------------------------------------------------------------------
    process(state, bit_counter, cmd_counter, shift_reg, mosi_reg)
    begin
...
architecture Behavioral of ADC_Acquisition_Engine is
    ...
    -- SAMPLE SIGNAL
    --------------------------------------------------------------------
    signal miso1_capture : std_logic := '0';
    signal miso2_capture : std_logic := '0';
