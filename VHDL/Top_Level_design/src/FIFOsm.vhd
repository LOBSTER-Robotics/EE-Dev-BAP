...
-- Module  Version: 5.1
--E:\Apps\Lattice Diamond\ispfpga\bin\nt64\scuba.exe -w -n FIFO_DAC -lang vhdl -synth lse -bus_exp 7 -bb -arch sa5p00 -type ebfifo -sync_mode -depth 1024 -width 16 -no_enable -pe 33 -pe2 49 -pf 700 -pf2 650 -reset_rel SYNC 

-- Tue May 05 13:05:06 2026
...
architecture Structure of FIFO_DAC is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "FIFO_DAC.lpc";
...
begin
    ...
    ae_clr_cmp_2: CCU2C
        generic map (INJECT1_1=> "NO", INJECT1_0=> "NO", INIT1=> X"99AA", 
        INIT0=> X"99AA")
        port map (A0=>scuba_vhi, A1=>scuba_vhi, B0=>fcount_4, 
            B1=>fcount_5, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
