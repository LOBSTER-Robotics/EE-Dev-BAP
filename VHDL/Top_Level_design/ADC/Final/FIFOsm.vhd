...
-- Module  Version: 5.1
--E:\Apps\Lattice Diamond\ispfpga\bin\nt64\scuba.exe -w -n FIFOsm -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00m -type ebfifo -sync_mode -depth 32 -width 24 -no_enable -pe 2 -pe2 4 -pf 30 -pf2 28 -reset_rel SYNC 
...
begin
    ...
    pdp_ram_0_0_0: PDPW16KD
        ...
        port map (DI35=>scuba_vlo, DI34=>scuba_vlo, DI33=>scuba_vlo, 
            ...
            ADW5=>scuba_vlo, ADW4=>wcount_4, ADW3=>wcount_3, 
    ...
    g_cmp_2: CCU2C
        ...
        port map (A0=>fcount_4, A1=>fcount_5, B0=>wren_i, B1=>wren_i_inv, 
            C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, D1=>scuba_vhi, 
            CIN=>co1_2, S0=>open, S1=>open, COUT=>cmp_ge_d1_c);
    ...
    af_set_cmp_2: CCU2C
        ...
        port map (A0=>fcount_4, A1=>fcount_5, B0=>scuba_vhi, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co1_7, S0=>open, S1=>open, 
            COUT=>af_set_d_c);
    ...
    af_clr_cmp_2: CCU2C
        ...
        port map (A0=>fcount_4, A1=>fcount_5, B0=>scuba_vhi, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co1_8, S0=>open, S1=>open, 
            COUT=>af_clr_d_c);
