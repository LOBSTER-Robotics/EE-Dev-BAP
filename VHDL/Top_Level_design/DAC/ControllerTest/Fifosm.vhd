...
-- Module  Version: 5.1
--E:\Apps\Lattice Diamond\ispfpga\bin\nt64\scuba.exe -w -n Fifosm -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -sync_mode -depth 32 -width 16 -no_enable -pe 2 -pe2 3 -pf 30 -pf2 29 -reset_rel SYNC 

-- Mon May 18 16:54:28 2026
...
begin
    ...
    ae_clr_cmp_1: CCU2C
        generic map (INJECT1_1=> "NO", INJECT1_0=> "NO", INIT1=> X"99AA", 
        INIT0=> X"99AA")
        port map (A0=>r_nw, A1=>scuba_vlo, B0=>fcount_2, B1=>fcount_3, 
            C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, D1=>scuba_vhi, 
    ...
    af_clr_cmp_0: CCU2C
        ...
        port map (A0=>fcount_0, A1=>fcount_1, B0=>fcnt_en_inv, B1=>r_nw, 
            C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, D1=>scuba_vhi, 
            CIN=>cmp_ci_5, S0=>open, S1=>open, COUT=>co0_8);
