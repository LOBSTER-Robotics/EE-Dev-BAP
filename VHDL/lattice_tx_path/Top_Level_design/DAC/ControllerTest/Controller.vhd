...
entity Controller is
    ...
    port (
        ...
        i_large_fifo_almost_empty : in std_logic_vector(G_NUM_CHANNELS-1 downto 0);
        ...
        i_small_fifo_almost_full : in std_logic;
...
architecture rtl of Controller is
    ...
    constant C_BYTES_PER_SAMPLE : positive := G_DAC_WIDTH / G_BYTE_WIDTH;
    ...
    subtype t_sample is std_logic_vector(G_DAC_WIDTH-1 downto 0);
...
begin
    ...
    o_small_fifo_wr_en <= s_small_fifo_rd_en;
    o_large_fifo_rd_en <= s_large_fifo_wr_en;
    o_small_fifo_din   <= s_large_fifo_din;
    ...
    begin
        ...
        case r_state is
            when S_IDLE =>
                ...
                r_next_byte    <= 0;
                if i_enable = '1' then
                    if all_small_fifos_ready(i_small_fifo_almost_full) then
                        if i_small_fifo_almost_full = '0' then
            ...
            when S_WRITE_BYTE =>
                ...
                if r_byte = C_BYTES_PER_SAMPLE - 1 then
                    ...
                    if r_channel = G_NUM_CHANNELS - 1 then
                        ...
                        if all_small_fifos_ready(i_large_fifo_almost_empty) then
                            if i_small_fifo_almost_full = '0' then
