...
-- Module  Version: 5.8
--D:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n DDR_forRGMII -lang vhdl -synth lse -bus_exp 7 -bb -arch sa5p00 -type iol -mode Transmit -io_type LVCMOS18 -width 5 -freq_in 125 -gear 2 -aligned -del -1 
...
architecture Structure of DDR_forRGMII is
    ...
    attribute IO_TYPE of Inst2_OB : label is "LVCMOS18";
    attribute IO_TYPE of Inst1_OB4 : label is "LVCMOS18";
    attribute IO_TYPE of Inst1_OB3 : label is "LVCMOS18";
    attribute IO_TYPE of Inst1_OB2 : label is "LVCMOS18";
    attribute IO_TYPE of Inst1_OB1 : label is "LVCMOS18";
    attribute IO_TYPE of Inst1_OB0 : label is "LVCMOS18";
