...
entity spi_master_dac is
    ...
    port (
        ...
        -- Upstream data interface (waveform generator)
        ...
        spi_sclk_o : out std_logic;                     -- To DAC8811 CLK  (idles LOW)
        spi_sdi_o  : out std_logic;                     -- To DAC8811 SDI  (MSB first)
        spi_cs_n_o : out std_logic                      -- To DAC8811 CS#  (active low)
    );
